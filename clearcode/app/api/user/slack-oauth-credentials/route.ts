...
export async function PUT(req: NextRequest) {
  ...
  await query(
    'UPDATE users SET slack_client_id = $1, slack_client_secret_encrypted = $2 WHERE id = $3',
...
export async function DELETE() {
  ...
  await query(
    'UPDATE users SET slack_client_id = NULL, slack_client_secret_encrypted = NULL WHERE id = $1',
    [session.user_id]
  )
